...
export function loadConfig(): ServerConfig {
    return {
        ...
        tlsKey: process.env.TLS_KEY_PATH || "/etc/letsencrypt/live/smtp.xmit.sh/privkey.pem",
        tlsCert: process.env.TLS_CERT_PATH || "/etc/letsencrypt/live/smtp.xmit.sh/fullchain.pem",
